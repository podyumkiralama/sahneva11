  ...
  return (
    <div className="overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 container py-12 md:py-16">
          <div className="max-w-6xl mx-auto text-center mb-10">
            ...
            {/* Birincil CTA'lar (accessible name = visible text) */}
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 md:gap-4 mb-12">
              ...
              >
                {/* aria-label vermiyoruz; görünür metin ad olarak kullanılsın */}
      ...
      <main id="main" className="relative">
        ...
        {/* ReviewBanner (kendi içinde buton/metin içeriyor) */}
          ...
          <div className="container relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                Türkiye geneli sahne, podyum, LED ekran kiralama ve ses-ışık sistemleri
                kurulumu
              </p>
            </div>
          ...
          <div className="container">
            ...
            <div className="grid gap-6 lg:gap-8 lg:grid-cols-2">
              <article className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 shadow-lg border border-blue-100">
                ...
                <div className="prose max-w-none text-neutral-700">
                  <p className="text-base leading-relaxed">
                    ...
                    hizmetlerinde komple çözümler sunuyoruz. Keşif, planlama, kurulum ve
                    canlı yönetim aşamalarının tamamını profesyonel ekibimiz yürütüyor.
                  </p>
              ...
              <article className="bg-gradient-to-br from-purple-50 to-white rounded-2xl p-6 shadow-lg border border-purple-100">
                ...
                <div className="prose max-w-none text-neutral-700">
                  <p className="text-base leading-relaxed">
                    İstanbul merkezli ekibimizle <strong>Türkiye'nin 81 ilinde</strong>{" "}
                    hizmet veriyoruz. Aynı gün kurulum, yedekli ekipman stoğu ve 7/24
                    teknik destek ile riskleri minimize ediyoruz. Müşterilerimize şeffaf
                    fiyatlandırma ve detaylı teklif sunuyoruz.
                  </p>
                  ...
                  <div className="mt-4 p-4 bg-white rounded-lg border border-purple-200 shadow-md">
                    ...
                    {/* Visible text = name; aria-label kaldırıldı */}
                    <a
                    ...
                    <p className="text-xs text-neutral-600 mt-2">
                      <strong>2 saat içinde</strong> detaylı teklif ve profesyonel
                      danışmanlık
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-neutral-200">
              ...
              <div className="prose max-w-none">
                <p className="text-lg leading-relaxed text-neutral-700 mb-6">
                  Konser, fuar, kongre, lansman ve protokol seviyesindeki etkinliklerde
                  yalnızca güçlü ekipman değil,{" "}
                  <strong className="text-blue-600">kusursuz operasyon yönetimi</strong>{" "}
                  ve{" "}
                  <strong className="text-blue-600">güvenli rigging çözümleri</strong>{" "}
                  esastır. Sahneva;{" "}
                  <a
                    href="/sahne-kiralama"
                  ...
                  'ndan truss ve scaffolding üst yapılara kadar tüm bileşenleri tek bir
                  teknik omurga altında birleştirir.
                </p>
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <p className="text-blue-800 text-sm">
                    ...
                    , zemin hazırlığı, dekoratif uygulamalar ve güç sistemleri dâhil;
                    etkinliğinizin tüm teknik ihtiyaçlarını tek çatı altında yönetiyoruz.{" "}
                    <strong>Türkiye'nin her yerinde aynı kalite ve profesyonellik.</strong>
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-12 bg-white" aria-labelledby="faq-title">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                Sahne, podyum, LED ekran kiralama ve kurulum hizmetlerimiz hakkında en çok
