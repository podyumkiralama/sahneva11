...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      ...
      {/* HERO – tek overlay, fotoğraf net */}
      <section
        className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-slate-900 pt-16 lg:pt-20"
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            ...
            style={{ filter: "brightness(0.88) contrast(1.05) saturate(1.03)" }}
          />
        </div>

        {/* İnce overlay */}
        <div
          className="absolute inset-0 bg-gradient-to-br from-slate-900/45 via-blue-900/30 to-purple-900/35 pointer-events-none"
          aria-hidden="true"
        />
        {/* Sheen efekti (yalnız md+) */}
        <div
          className="absolute inset-0 md:block hidden bg-gradient-to-r from-transparent via-white/10 to-transparent pointer-events-none"
          aria-hidden="true"
        />
      ...
      <main id="main" className="relative">
              ...
              <article className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 shadow-lg border border-blue-100">
                ...
                <div className="prose max-w-none text-neutral-700">
                  <p className="text-base leading-relaxed">
                    ...
                    <a href="/led-ekran-kiralama" className="text-blue-600 hover:text-blue-700 font-semibold underline decoration-2 underline-offset-4 transition-colors">LED ekran kiralama</a>{" "}
                    ve{" "}
        ...
        <section className="py-12 bg-gradient-to-br from-neutral-50 to-blue-100/50" aria-labelledby="buyuk-etkinlik-baslik">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-neutral-200">
              ...
              <div className="prose max-w-none">
                <p className="text-lg leading-relaxed text-neutral-700 mb-6">
                  ...
                  <strong className="text-blue-600">güvenli rigging çözümleri</strong> esastır.
                </p>
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <p className="text-blue-800 text-sm">
                    <a href="/cadir-kiralama" className="text-blue-600 hover:text-blue-700 font-semibold underline">Çadır kurulumu</a>, zemin hazırlığı, dekoratif uygulamalar ve güç sistemleri dahil; etkinliğinizin tüm teknik ihtiyaçlarını tek çatı altında yönetiyoruz.
                  </p>
                </div>
              </div>
            </div>
