...
// Kahraman görselini statik import ederek LCP + blur’u Next’e bırak
// Projende "@/public" alias'ı yoksa şu şekilde değiştir: import heroImg from "../../public/img/hero-bg.webp";
...
// Dynamic imports (SSR kapatmıyoruz; yalnızca loading skeleton veriyoruz)
...
/** ##############  STRUCTURED DATA (3 ADET)  ##############
 * 1) Organization
 * 2) WebSite + SearchAction
 * 3) Service (+OfferCatalog) — provider: Organization
 */
...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      ...
      {/* HERO — görünümü bozmadan LCP’yi iyileştiren mikro ayarlar */}
      <section
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-12">
              {[{icon:"⭐",title:"4.9/5 Puan",description:"500+ Mutlu Müşteri",color:"from-yellow-400 to-orange-400"},
                ...
                {icon:"👑",title:"Premium",description:"Kalite Garantisi",color:"from-purple-400 to-pink-400"}].map((item, i) => (
                <div
                  key={i}
      ...
      <main id="main" className="relative">
        {/* CLS için küçük bir guard ve ReviewBanner’ı sticky yapısı */}
        ...
        {/* “Neden Sahneva?” uzun metin bloğu */}
