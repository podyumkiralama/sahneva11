...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.sahneva.com/img/og-hakkimizda.jpg", // 👈 mutlak URL
        width: 1200,
        height: 630,
...
function StaticStats() {
  const stats = [
    { number: "700+", label: "Başarılı Proje", color: "from-blue-500 to-cyan-500" },
    { number: "12+", label: "Yıl Deneyim", color: "from-purple-500 to-pink-500" },
    { number: "81", label: "İlde Hizmet", color: "from-green-500 to-emerald-500" },
  ];
  ...
  const TIMELINE = [
    {
      ...
      title: "Başlangıç",
      description:
        "Butik sahne ve ses hizmetleri ile sektörde ilk adımlarımızı attık. Müşteri memnuniyeti odaklı hizmet anlayışımızı bu yılda temellendirdik.",
      icon: "🚀",
    },
    {
      year: "2016",
      ...
      description:
        "LED ekran ve görüntü sistemlerini filomuza katarak görsel prodüksiyon yetkinliğimizi güçlendirdik. İstanbul merkezli operasyonumuzu Anadolu'ya genişlettik.",
      icon: "🖥️",
    },
    {
      year: "2020",
      ...
      description:
        "Türkiye geneli lojistik ağımızı kurduk. Büyük ölçekli kurumsal etkinliklerde güvenilir çözüm ortağı olarak konumlandık.",
      icon: "🏢",
    },
    {
      year: "2024",
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      >
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            ...
            style={{ transform: "scale(1.02)", filter: "brightness(0.6) contrast(1.1) saturate(1.1)" }}
          />
        </div>
        ...
        <div className="relative z-10 container text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-12 leading-relaxed max-w-3xl mx-auto font-light">
              Türkiye'nin <strong className="text-blue-300 font-semibold">1 numaralı etkinlik teknoloji partneri</strong> olarak
              <br />
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              >
                <span className="flex items-center gap-2">
                  Tarihçemiz <span className="group-hover:translate-x-1 transition-transform">→</span>
                </span>
              </a>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2">
          <div className="motion-safe:animate-bounce"> {/* 👈 hareket-kısıt uyumlu */}
      ...
      <main id="main" className="relative">
        {/* BİZ KİMİZ */}
        <section className="py-20 bg-gradient-to-br from-white to-blue-50/50" aria-labelledby="biz-kimiz-title">
        ...
        {/* DEĞERLERİMİZ */}
        <section className="py-20 bg-gradient-to-br from-neutral-50 to-blue-100/30" aria-labelledby="degerlerimiz-title">
          <div className="container max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
        ...
        {/* TARİHÇE */}
        <section id="tarihce" className="py-20 bg-gradient-to-br from-white to-purple-50/50" aria-labelledby="tarihce-title">
          <div className="container max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
        ...
        {/* VİZYON & MİSYON */}
        <section className="py-20 bg-gradient-to-br from-white to-blue-50/50" aria-labelledby="vizyon-title">
          <div className="container max-w-6xl mx-auto px-4">
