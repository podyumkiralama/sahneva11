...
function ContactStructuredData() {
  ...
  return (
    <script
      ...
      // CSP'mizde 'unsafe-inline' açık; ileride nonce/hashing'e geçebiliriz.
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
        ...
        <div className="relative z-10 container text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
              Etkinliğiniz için <strong className="text-blue-300">en uygun çözümleri</strong>{" "}
              sunalım<br />
              <strong className="text-purple-300">2 saat içinde detaylı teklif</strong>{" "}
              hazırlıyoruz
            </p>
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-xl text-neutral-600 mb-8">
                    Türkiye geneli hizmet veriyoruz. Ofisimizi ziyaret etmek için haritayı
                    kullanabilirsiniz.
                  </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <span className="flex items-center justify-center gap-2">📍 Haritalar'da Aç</span>
                  </a>
                  <a
                    href={GMB_REVIEW_URL}
                    target="_blank"
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-neutral-200 p-8" id="teklif-formu">
                ...
                >
                  ...
                  >
                    <span className="flex items-center justify-center gap-2">🚀 Hemen Teklif Al</span>
                  </button>

                  <p className="text-xs text-neutral-500 text-center">
                    Formu göndererek{" "}
                    <Link href="/gizlilik-politikasi" className="text-blue-600 hover:text-blue-700 underline">
          ...
          <div className="container max-w-4xl mx-auto px-4 text-center text-white">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-12 border border-white/20">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                ...
                >
                  <span className="flex items-center justify-center gap-2">🚨 Acil Destek Hattı</span>
                </a>
                ...
                >
                  <span className="flex items-center justify-center gap-2">💬 WhatsApp Destek</span>
                </a>
              </div>

              <div className="mt-8 p-4 bg-yellow-500/20 rounded-xl border border-yellow-400/30 max-w-2xl mx-auto">
                <p className="text-yellow-200 text-sm">
                  <strong>⏰ 7/24 Hizmet:</strong> Mevcut etkinliklerinizde yaşadığınız teknik
                  sorunlarda aynı gün içinde çözüm sunuyoruz.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white shadow-2xl border-t py-4 flex justify-around md:hidden z-50">
        <a href={`tel:${PHONE}`} className="flex flex-col items-center text-blue-600 font-bold text-sm">
        ...
        <a href="#teklif-formu" className="flex flex-col items-center text-purple-600 font-bold text-sm">
          <span className="text-lg">📝</span>
          <span>Teklif Al</span>
        </a>
      </div>
...
function ContactCard({ icon, title, info, description, href, color, buttonText }) {
  return (
    <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl border border-neutral-100 hover:border-blue-200 transition-all duration-500 hover:scale-105 text-center">
      <div className={`text-5xl mb-4 bg-gradient-to-r ${color} text-transparent bg-clip-text`}>{icon}</div>
