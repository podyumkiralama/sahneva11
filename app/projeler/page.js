  ...
  return (
    <main id="main" className="min-h-screen bg-[#0b0f1a] text-white">
      <section className="mx-auto max-w-7xl px-4 pt-32 pb-16">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4" role="list" aria-label="Proje listesi">
          {projects.map((p) => (
            <li
              key={p.slug}
            ...
            >
              <article className="flex flex-col h-full">
                <Link
                  ...
                  className="relative aspect-[16/9] overflow-hidden rounded-t-2xl block focus:outline-none"
