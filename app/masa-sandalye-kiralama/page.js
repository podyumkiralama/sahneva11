...
const WA_TEXT = "Merhaba%2C+masa+sandalye+kiralama+icin+teklif+istiyorum.+Etkinlik+turu%3A+%5Bdavet%2Fkonferans%2Fkokteyl%5D%2C+Tarih%3A+%5Bgg.aa.yyyy%5D%2C+Kisi+sayisi%3A+%5Bxxx%5D.";
...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Davet, konferans ve kokteyl düzenleri için masa sandalye kiralama. Örtü-kılıf, planlama ve profesyonel kurulum.",
...
const SERVICES = [
  {
    ...
    description: "Klasik ve şık tasarım, ahşap/PP seçenekleri ile davetler için ideal",
    features: ["Ahşap & PP modeller", "Beyaz/Krem renk", "Stackable tasarım", "Rahat oturum"],
  },
  {
    icon: "💼",
    title: "Konferans Sandalyeleri",
    description: "Yastıklı, profesyonel görünüm, uzun süreli oturumlar için konfor",
    features: ["Yastıklı oturma", "Profesyonel görünüm", "Katlanabilir", "Hafif taşınabilir"],
  },
  {
    icon: "🎪",
    title: "Banket Masaları",
    description: "Yuvarlak ve dikdörtgen masalar, her etkinliğe uygun çözümler",
    features: ["Ø180 yuvarlak", "180×75 dikdörtgen", "Hızlı kurulum", "Sağlam yapı"],
  },
  {
    icon: "🥂",
    title: "Bistro Masalar",
    description: "Kokteyl ve networking etkinlikleri için kompakt çözümler",
    features: ["Ø60-80 cm", "Hafif tasarım", "Strech kılıf", "Mobil kullanım"],
  },
  {
    icon: "🧵",
    title: "Örtü & Kılıf Sistemleri",
    description: "Keten, tafta, strech kumaşlar ile zengin renk ve doku seçenekleri",
    features: ["Keten örtüler", "Tafta şallar", "Strech kılıflar", "20+ renk"],
  },
  {
    icon: "🗺️",
    title: "Planlama & Yerleşim",
    description: "Oturma planı, numaralandırma ve profesyonel yerleşim hizmetleri",
    features: ["Oturma planı", "Masa numaralandırma", "Profesyonel kurulum", "Yönlendirme"],
  },
];
...
// Paket verileri (mevcut yapı korunacak)
const PACKAGES = [
  {
    id: "davet-100",
    ...
    <section className="relative flex items-center justify-center overflow-hidden bg-slate-900 pt-20 min-h-[80vh]" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white py-12">
        ...
        <h1 id="hero-title" className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight mb-4 drop-shadow-2xl">
          Profesyonel <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-300">Masa Sandalye Kiralama</span>
        </h1>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Masa sandalye kiralama hizmetlerimiz: geniş envanter, örtü-kılıf sistemleri ve profesyonel yerleşim
          </p>
        </div>
                ...
                <div className="bg-gradient-to-r from-blue-700 to-purple-700 p-8 text-white relative overflow-hidden">
                  {pkg.badge && (
                    <div className={`absolute top-4 right-4 px-4 py-2 rounded-full text-sm font-bold ${
                      ...
                      pkg.badge === "Kurumsal" ? "bg-blue-600" : "bg-green-500"
                    }`}>
                      {pkg.badge}
                    </div>
                  )}
  ...
  const technicalItems = [
    {
      ...
      description: "Napolyon, konferans ve protokol sandalyeleri ile her ihtiyaca uygun",
      features: ["Napolyon (ahşap/PP)", "Konferans (yastıklı)", "Protokol sandalyeleri", "Stackable tasarım"]
    },
    {
      category: "masa",
      title: "Masa Sistemleri",
      description: "Banket, konferans ve bistro masalar ile esnek çözümler",
      features: ["Ø180 banket masalar", "180×75 dikdörtgen", "Bistro masalar", "Hızlı kurulum"]
    },
    {
      category: "ortu",
      title: "Örtü & Kılıf",
      description: "Zengin renk ve kumaş seçenekleri ile estetik çözümler",
      features: ["Keten masa örtüleri", "Tafta şallar", "Strech kılıflar", "20+ renk seçeneği"]
    },
    {
      category: "planlama",
      title: "Planlama Sistemleri",
      description: "Profesyonel oturma planı ve yerleşim hizmetleri",
      features: ["Oturma planı tasarımı", "Masa numaralandırma", "Yönlendirme tabelaları", "Alan optimizasyonu"]
    },
    {
      category: "lojistik",
      title: "Lojistik & Kurulum",
      description: "Hızlı teslimat ve profesyonel kurulum hizmetleri",
      features: ["Aynı gün teslimat", "Profesyonel kurulum", "Yerleşim hizmeti", "Toplama & taşıma"]
    },
    {
      category: "destek",
      title: "Teknik Destek",
      description: "7/24 teknik destek ve operasyon yönetimi",
      features: ["7/24 teknik destek", "Operasyon yönetimi", "Acil müdahale", "Profesyonel ekip"]
    }
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white" aria-labelledby="altyapi-baslik">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Geniş envanter, profesyonel ekipman ve uzman ekip ile hizmetinizdeyiz
          </p>
        </div>
      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/85 max-w-3xl mx-auto leading-relaxed">
            Masa sandalye çözümlerimizin tercih edildiği başlıca etkinlik türleri ve özel çözümlerimiz
          </p>
    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50/50" aria-labelledby="bilgi-rehber-baslik">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Masa sandalye kiralama ve etkinlik planlama hakkında uzman görüşleri ve teknik bilgiler
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <header className="bg-gradient-to-r from-blue-700 via-purple-700 to-blue-800 text-white p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-black tracking-tight leading-tight">
                  Masa Sandalye Kiralama: Etkinlik Başarınız İçin Konfor ve Estetik
                </h3>
                <p className="text-blue-100 mt-4 text-lg md:text-xl leading-relaxed">
                  En doğru ürün seçimi, profesyonel yerleşim ve estetik detaylar ile etkinliklerinizde mükemmel performans
                </p>
              </div>
            </header>
              ...
              <div className="prose prose-lg max-w-none prose-headings:font-black prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-em:text-gray-600 prose-ul:mt-6 prose-ul:mb-6 prose-li:marker:text-blue-500">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="space-y-6">
                    ...
                    <p>
                      ...
                      <Link href="/masa-sandalye-kiralama" className="font-semibold text-blue-600 hover:text-blue-700 underline underline-offset-4">
                        profesyonel masa sandalye kiralama
                      </Link>{" "}
                      hizmetleriyle kurumsal standartta çözümler sunmaktadır.
                    </p>
                    <p>
                      Etkinliğiniz ister düğün organizasyonu, ister kurumsal konferans olsun; detaylı ihtiyaç analizi, 
                      ürün optimizasyonu, profesyonel kurulum ve canlı operasyon dahil{" "}
                  ...
                  <div className="space-y-6">
                    ...
                    <p>
                      Davet etkinliklerinde yuvarlak banket masalar, konferanslarda dikdörtgen masalar, 
                      kokteyl etkinliklerinde ise bistro masalar ile her koşulda fonksiyonel ve estetik çözümler sunuyoruz.
                    </p>
                    <p>
                      Ø180 yuvarlak, 180×75 dikdörtgen ve Ø60-80 bistro masa seçeneklerimizle, 
                      mekan boyutuna ve etkinlik türüne göre optimize edilmiş çözümler sunarak 
                      hem konfor hem de estetik sorunlarını ortadan kaldırıyoruz.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-blue-500 rounded-r-2xl p-6 mb-8">
                  ...
                  <p className="text-gray-700 text-lg mb-0 leading-relaxed">
                    Masa sandalye seçiminde etkinlik süresi ve konfor ihtiyacı en kritik faktördür. Kısa süreli etkinlikler 
                    için Napolyon sandalyeler, uzun süreli oturumlar için konferans sandalyeleri öneriyoruz. Açık hava 
                    etkinliklerinde ise dayanıklılık ve hava koşullarına uygunluk öncelikli değerlendirilmelidir.
                  </p>
                </div>
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-2xl p-6 mt-8">
                  ...
                  <p className="text-yellow-800 mb-0">
                    ...
                    masa sandalye kiralama konusunda güvenilir çözüm ortağınız. Geniş envanter, 
          ...
          <article className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 h-full">
            ...
            <div className="p-6 md:p-8">
              <div className="prose prose-lg max-w-none prose-p:text-gray-600 prose-p:leading-relaxed">
                <p>
                  Masa örtüsü ve kılıf seçimleri etkinliğinizin estetik görünümünü doğrudan etkiler. 
                  Keten kumaşlar şıklık ve doğallık, tafta kumaşlar parlaklık ve lüks, strech kılıflar 
                  ise pratiklik ve modern görünüm sunar.
                </p>
                <p>
                  20+ renk seçeneğimiz ile marka kimliğinize veya etkinlik temanıza uygun 
                  renk kombinasyonları oluşturabilir, runner ve şal detayları ile 
                  masalarınızı özelleştirebilirsiniz.
                </p>
          ...
          <article className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 h-full">
            <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 md:p-8">
              ...
              <p className="text-blue-100 mt-2 text-lg">
                Profesyonel oturma planı ve alan optimizasyonu için uzman ipuçları
              </p>
            </header>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-2xl p-5 border border-blue-200">
                    ...
                    <p className="text-gray-700 text-base mb-0">
                      Yuvarlak masalarda 8-10 kişi ideal, dans pisti çevresinde 2.5m sirkülasyon, 
                      masa numaralandırma ve yönlendirme sistemleri
                    </p>
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-2xl p-5 border border-purple-200">
                    ...
                    <p className="text-gray-700 text-base mb-0">
                      Sahne görüşü için tiyatro/sınıf düzeni, U/boardroom toplantı masaları, 
                      acil çıkış akslarında 1.5m serbest alan
                    </p>
                  </div>
    ...
    >
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Masa sandalye kurulumunuzu tamamlayacak diğer profesyonel etkinlik çözümlerimiz
          </p>
          <div 
        ...
        <div className="sr-only">
          <p>
            Bu bölümde masa sandalye kurulumunuzu tamamlayacak diğer hizmetlerimiz bulunmaktadır. 
        ...
        <div className="bg-gradient-to-r from-blue-700 to-purple-700 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
              Etkinliğiniz için en uygun masa sandalye sistemlerini sunalım. Ücretsiz keşif, profesyonel danışmanlık ve 
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description: "Profesyonel masa sandalye kiralama hizmeti. Napolyon ve konferans sandalyeleri, banket ve bistro masalar, örtü-kılıf sistemleri ve profesyonel yerleşim hizmetleri ile Türkiye genelinde hizmet.",
        provider: {
          "@type": "Organization",
          name: "Sahneva",
        ...
        offers: {
          "@type": "Offer",
          description: "Profesyonel masa sandalye kiralama hizmeti"
        },
        url: `${ORIGIN}/masa-sandalye-kiralama`,
        aggregateRating: { 
