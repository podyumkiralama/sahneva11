...
const WA_TEXT = "Merhaba%2C+sahne+kiralama+icin+teklif+istiyorum.+Etkinlik+turu%3A+%5Bkonser%2Fkonferans%2Flansman%5D%2C+Tarih%3A+%5Bgg.aa.yyyy%5D%2C+Katilimci+sayisi%3A+%5Bxxx%5D%2C+Tahmini+sahne+olcusu%3A+%5Bm²%5D.";
...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Konser, konferans, lansman ve festival etkinlikleri için truss, podyum, LED ekran, ses ve ışık sistemleri ile anahtar teslim sahne çözümleri.",
  ...
  twitter: {
    ...
    title: "Sahne Kiralama | Profesyonel Sahne Çözümleri | Sahneva",
    description: "Konser, konferans, lansman ve festival etkinlikleri için profesyonel sahne çözümleri.",
...
const SERVICES = [
  {
    ...
    description: "1×1 ve 2×1 podyum panelleri ile esnek ve hızlı kurulum çözümleri",
    features: ["1×1 & 2×1 paneller", "Modüler tasarım", "Hızlı kurulum", "Esnek konfigürasyon"],
  },
  {
    icon: "🏗️",
    title: "Truss & Rigging Sistemleri",
    description: "Alüminyum truss sistemleri, profesyonel rigging ve güvenlik ekipmanları",
    features: ["Alüminyum truss", "Profesyonel rigging", "Güvenlik sistemleri", "Statik hesaplama"],
  },
  {
    icon: "🖥️",
    title: "LED Ekran Entegrasyonu",
    description: "P2-P6 LED ekranlar, video wall sistemleri ve canlı yayın çözümleri",
    features: ["P2-P6 LED ekranlar", "Video wall sistemleri", "Canlı yayın", "4K çözünürlük"],
  },
  {
    icon: "🎵",
    title: "Ses & Işık Sistemleri",
    description: "Profesyonel ses sistemleri, ışık tasarımı ve canlı performans çözümleri",
    features: ["Line array ses sistemleri", "Işık tasarımı", "DMX kontrol", "Canlı performans"],
  },
  {
    icon: "⚡",
    title: "Teknik Altyapı",
    description: "Güç dağıtım, kablo yönetimi ve profesyonel teknik altyapı çözümleri",
    features: ["Güç dağıtım", "Kablo yönetimi", "Teknik altyapı", "Profesyonel ekip"],
  },
  {
    icon: "🔧",
    ...
    <section className="relative flex items-center justify-center overflow-hidden bg-slate-900 pt-20 min-h-[80vh]" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white py-12">
        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-lg rounded-xl px-4 py-2 border border-white/30 mb-6">
          ...
          <span className="text-sm font-bold text-white">Türkiye Geneli Profesyonel Kurulum</span>
        </div>

        <h1 id="hero-title" className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight mb-4 drop-shadow-2xl">
          Profesyonel <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-300">Sahne Kiralama</span>
        </h1>
        ...
        <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-normal mb-6">
          ...
          <span className="font-semibold text-white"> anahtar teslim sahne çözümleri</span>
        </p>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Sahne kiralama hizmetlerimiz: modüler sistemler, truss rigging, LED ekran entegrasyonu ve profesyonel kurulum
          </p>
        </div>
  ...
  const technicalItems = [
    {
      ...
      description: "1×1 ve 2×1 modüler paneller ile esnek ve güvenli sahne çözümleri",
      features: ["1×1 & 2×1 paneller", "20-100 cm yükseklik", "Kaymaz kaplama", "Merdiven & rampa"]
    },
    {
      category: "truss",
      title: "Truss & Rigging",
      description: "Alüminyum truss sistemleri, profesyonel rigging ve güvenlik ekipmanları",
      features: ["Alüminyum truss", "Profesyonel rigging", "Statik hesaplama", "Güvenlik sistemleri"]
    },
    {
      category: "led",
      title: "LED Ekran Sistemleri",
      description: "P2-P6 LED ekranlar, video wall sistemleri ve canlı yayın çözümleri",
      features: ["P2-P6 LED ekranlar", "Video wall sistemleri", "4K çözünürlük", "Canlı yayın"]
    },
    {
      category: "ses",
      title: "Ses Sistemleri",
      description: "Profesyonel ses sistemleri, mikserler ve kablosuz ekipmanlar",
      features: ["Line array sistemler", "Dijital mikserler", "Kablosuz mikrofonlar", "Monitör sistemleri"]
    },
    {
      category: "isik",
      title: "Işık Sistemleri",
      description: "Hareketli ışık başlıkları, LED wash ve profesyonel ışık tasarımı",
      features: ["Hareketli başlıklar", "LED wash ışıklar", "DMX kontrol", "Işık tasarımı"]
    },
    {
      category: "guvenlik",
      title: "Güvenlik Sistemleri",
      description: "Korkuluk, rampa, acil çıkış ve profesyonel güvenlik önlemleri",
      features: ["Kenar korkulukları", "Engelli rampaları", "Acil çıkış planlaması", "Güvenlik ekipmanları"]
    }
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white" aria-labelledby="altyapi-baslik">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            En son teknoloji sahne sistemleri ve profesyonel teknik altyapı ile hizmetinizdeyiz
          </p>
        </div>
      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/85 max-w-3xl mx-auto leading-relaxed">
            Sahne çözümlerimizin tercih edildiği başlıca etkinlik türleri ve özel çözümlerimiz
          </p>
    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50/50" aria-labelledby="bilgi-rehber-baslik">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Sahne kiralama ve etkinlik planlama hakkında uzman görüşleri ve teknik bilgiler
          </p>
        </div>
            ...
            <header className="bg-gradient-to-r from-blue-700 via-purple-700 to-blue-800 text-white p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-black tracking-tight leading-tight">
                  Profesyonel Sahne Kiralama: Etkinlik Başarınız İçin Anahtar Teslim Çözümler
                </h3>
                <p className="text-blue-100 mt-4 text-lg md:text-xl leading-relaxed">
                  Modüler sahne sistemleri, truss rigging, LED ekran entegrasyonu ve profesyonel ekip ile etkinliklerinizde mükemmel performans
                </p>
              </div>
            </header>
              ...
              <div className="prose prose-lg max-w-none prose-headings:font-black prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-em:text-gray-600 prose-ul:mt-6 prose-ul:mb-6 prose-li:marker:text-blue-500">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="space-y-6">
                    ...
                    <p>
                      ...
                      <Link href="/sahne-kiralama" className="font-semibold text-blue-600 hover:text-blue-700 underline underline-offset-4">
                        profesyonel sahne kiralama
                      </Link>{" "}
                      hizmetleriyle kurumsal standartta çözümler sunmaktadır.
                    </p>
                    <p>
                      Etkinliğiniz ister konser sahnesi, ister kurumsal konferans olsun; detaylı teknik keşif, 
                      sahne optimizasyonu, profesyonel kurulum ve canlı operasyon dahil{" "}
                  ...
                  <div className="space-y-6">
                    ...
                    <p>
                      Tüm truss sistemlerimiz alüminyum malzemeden üretilmiş olup, statik hesaplamalar ve 
                      güvenlik testleri ile en yüksek standartlara uygun olarak kurulmaktadır.
                    </p>
                    <p>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-blue-500 rounded-r-2xl p-6 mb-8">
                  ...
                  <p className="text-gray-700 text-lg mb-0 leading-relaxed">
                    Sahne seçiminde etkinlik türü ve katılımcı sayısı en kritik faktördür. Küçük etkinlikler (50-100 kişi) 
                    için 12-24 m², orta ölçekli etkinlikler (100-300 kişi) için 24-48 m², büyük etkinlikler (300+ kişi) 
                    için 48+ m² sahne alanı öneriyoruz. Açık hava etkinliklerinde ise rüzgar yükü ve zemin stabilitesi 
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-2xl p-6 mt-8">
                  ...
                  <p className="text-yellow-800 mb-0">
                    <strong>8+ yıllık deneyim, 300+ başarılı proje ve 81 ilde hizmet</strong> ile 
                    sahne kiralama konusunda güvenilir çözüm ortağınız. En son teknoloji ekipman, 
          ...
          <article className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 h-full">
            ...
            <div className="p-6 md:p-8">
              <div className="prose prose-lg max-w-none prose-p:text-gray-600 prose-p:leading-relaxed">
                <p>
                  Truss sistemleri sahne güvenliğinin temel taşlarıdır. Tüm sistemlerimiz 
                  TS EN 13814 sahne güvenlik standartlarına uygun olarak tasarlanmış ve kurulmuştur.
                </p>
                <p>
                  Alüminyum malzeme, yüksek güvenlik katsayıları, profesyonel rigging ekipmanları 
                  ve deneyimli ekip ile her türlü etkinlik için güvenli çözümler sunuyoruz.
                </p>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-2xl p-5 border border-blue-200">
                    ...
                    <p className="text-gray-700 text-base mb-0">
                      Yüksek stabilite, geniş performans alanı, line array ses sistemleri, profesyonel ışık/ses entegrasyonu
                    </p>
                  </div>
                  ...
                  <div className="bg-green-50 rounded-2xl p-5 border border-green-200">
                    ...
                    <p className="text-gray-700 text-base mb-0">
                      Dekoratif kaplamalar, nikah sahnesi, dans platformu, estetik detaylar
                    </p>
                  </div>
                </div>
              </div>
    ...
    >
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Sahne kurulumunuzu tamamlayacak diğer profesyonel etkinlik çözümlerimiz
          </p>
          <div 
        ...
        <div className="sr-only">
          <p>
            Bu bölümde sahne kurulumunuzu tamamlayacak diğer hizmetlerimiz bulunmaktadır. 
        ...
        <div className="bg-gradient-to-r from-blue-700 to-purple-700 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
              Etkinliğiniz için en uygun sahne sistemlerini sunalım. Ücretsiz keşif, profesyonel danışmanlık ve 
