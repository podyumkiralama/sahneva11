...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    return (
    <>
      <header className="bg-white shadow-md border-b border-neutral-200 fixed top-0 inset-x-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          >
            <Image
              src="/img/logo.png"
              alt="Sahneva kurumsal logosu - Sahne, LED ekran, podyum kiralama"
              width={160}
              height={40}
              priority={pathname === "/"}
              loading="eager"
          ...
          >
            ...
            <Link
              href="/iletisim"
              title="Sahneva iletişim bilgileri"
              className={`text-[15px] font-medium px-3 py-2 rounded-lg transition ${
                active("/iletisim")
                  ? "text-blue-700 bg-blue-50 border border-blue-200"
                  : "text-neutral-800 hover:text-blue-700 hover:bg-neutral-100"
      ...
      >
        <div className="px-5 py-6 space-y-3 max-h-[80vh] overflow-y-auto">
          ...
          <a
            ...
            title="WhatsApp üzerinden teklif alın"
            onClick={() => setMobileOpen(false)}
            className="block text-center rounded-lg px-5 py-3 text-white text-sm font-semibold bg-green-700 hover:bg-green-800 transition shadow-md"
          >
            💬 WhatsApp Teklif
          </a>
        </div>
