              ...
              <div className="utility-panel-content space-y-4 rounded-2xl border border-black/10 bg-white/95 p-4 text-sm text-slate-700 shadow-xl">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2 min-[480px]:flex-row">
                    <button
                      onClick={() => bumpFont(-1)}
                      className="utility-hc-button flex-1 rounded-lg border border-slate-200 px-3 py-2 font-semibold text-slate-600 hover:bg-slate-100"
                    >
                      A-
                    </button>
                    <button
                ...
                <button
                  ...
                  className="utility-hc-button flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100"
            ...
            >
              ...
              <div className="utility-panel-content flex w-48 flex-col gap-2 rounded-2xl border border-black/10 bg-white/95 p-4 text-sm text-slate-700 shadow-xl">
                <a
                  ...
                  className="utility-hc-button flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-3 py-2 font-medium text-white hover:bg-blue-500"
                >
                  📞 Hemen Ara
                </a>
                <a
                  ...
                  className="utility-hc-button flex items-center justify-center gap-2 rounded-lg bg-emerald-500 px-3 py-2 font-medium text-white hover:bg-emerald-400"
                >
                  💬 WhatsApp'tan Yaz
                </a>
              </div>
        ...
        >
          ...
          >
            <div className="flex flex-col gap-3 border-b border-slate-200 bg-slate-50 p-5 md:flex-row md:items-center">
              ...
              <button
                className="utility-hc-button w-full rounded-lg bg-slate-600 px-4 py-3 text-sm font-medium text-white hover:bg-slate-500 md:w-auto"
                onClick={() => {
                  setSearchOpen(false);
                  setActiveTool(null);
                  lastFocusRef.current?.focus?.();
                ...
                <div className="flex flex-col gap-2" role="list">
                  {filtered.map((route) => (
                    <Link
                      key={route.href}
                      href={route.href}
                      className="utility-hc-button flex items-center gap-3 rounded-lg border border-transparent px-4 py-3 text-slate-700 hover:bg-slate-100"
                      onClick={() => {
                        setSearchOpen(false);
                        setActiveTool(null);
                        lastFocusRef.current?.focus?.();
            ...
            <div className="border-t border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
              <p>
                <strong>İpucu:</strong> "sahne", "led ekran", "ses sistemi" gibi kelimeler aramayı kolaylaştırır
              </p>
            </div>
          </div>
        </div>
