          ...
          {CARDS.map((card) => (
            ...
            >
              ...
              <div className="relative p-6 bg-white/80 backdrop-blur-sm">
                <h3 className={`font-bold text-xl mb-3 ${card.color}`}>{card.title}</h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    <span>Teklif Al</span>
                    <span className="transform group-hover/link:translate-x-1 transition-transform duration-200" aria-hidden="true">
                      →
                    </span>
                  </Link>
